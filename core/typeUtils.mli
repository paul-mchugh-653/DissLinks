...
val select_type : string -> Types.datatype -> Types.datatype * bool
val split_choice_type : string -> Types.datatype -> (Types.datatype * Types.datatype)
val choice_at : string -> Types.datatype -> Types.datatype * bool
...
val row_present_types : Types.datatype -> (Types.datatype * bool) Utility.StringMap.t
